  ...
  <section id = "main">
    <div class ="container" id="text2">
      ...
      <div class ="row">
          ...
          <nav id="options">
            <div class="nav-wrapper">
              <ul class="left hide-on-med-and-down">
                ...
                <li class ="active"><a>MODIFY QUESTION</a></li>
        ...
        <form class="col s12 form1" action = "do_mod.php" method = "POST">
        <br>
          <div class="row">
            <div class="input-field col s7 offset-s2">
              <i class="material-icons prefix">account_circle</i>
              <input id="icon_prefix " type="text" class="validate" name = "qname" required>
              <label for="icon_prefix"><span id = "format">Question Name (Existing) </span></label>
            </div>
            ...
            <div>
                <button class="btn waves-effect waves-light col s4 offset-s4" type="submit" name="action"><span id = "format">Modify Question</span></button>
            </div>
            <br>
          </div>
        </form>
